         ...
         <c:otherwise>
            ...
            <table  class="table03" >
               <tr>
                  <c:choose>
                     <c:when test="${sessionInfo.role == 0  || sessionInfo.hiddenManager == true}">
                        <th style="width: 3%;" rowspan="2">선택</th>
                     </c:when>
                  </c:choose>
                  <th style="width: 3%;" rowspan="2">순번</th>
                  <th style="width: 5%;" rowspan="2">시공일</th>
                  <th style="width: 5%;" rowspan="2">파일종류</th>
                  <th style="width: 4%;" rowspan="2">공법</th>
                  <th style="width: 3%;"rowspan="2">위치</th>
                  <th style="width: 4%;"rowspan="2">파일번호</th>
                  <th style="width: 3%;"rowspan="2">파일규격 D</th>
                  <th colspan="6">파일규격</th>
                  
                  <th style="width: 3%;"rowspan="2">이음개소(EA)</th>
                  ...
                  <th style="width: 4%;" rowspan="2">극한지지력<br>(kN)</th>
                  <c:choose>
      ...
      <c:choose>
         <c:when test="${param.mode eq 'simple'}">
            <tr style="background: white;">
               <td  style="width: 20%;">
                  ${domain.currentDateTime} <input type="button" value="기록지확인"  onclick="location.href='${pageContext.request.contextPath}/report/list?id=${param.id}&date=${domain.currentDateTime}'">
               </td>
               <td  style="width: 20%;">
                  &nbsp;
               </td>
         ...
         <c:otherwise>
            <tr>
               ...
               <td style="width: 5%;">
                ...
                <td style="width: 5%;">
                   <input type="text" id="pileType" name="pileType" disabled="disabled" style="width: 70px;" value="${domain.pileType}">
                </td>
               <td style="width: 4%;">
                  <input type="text" id="method" name="method" disabled="disabled" style="width: 70px;" value="${domain.method}">
               </td>
               <td style="width: 3%;">
                  <input type="text" id="location" name="location" disabled="disabled" style="width: 60px;" value="${domain.location}">
               </td>
               <td style="width: 4%;">
                  <input type="text" id="pileNo" name="pileNo" disabled="disabled" style="width: 80px;" value="${domain.pileNo}">
               </td>
               <td style="width: 3%;">
